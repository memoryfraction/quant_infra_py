...
class TestCorrelationFactor(unittest.TestCase):
    ...
    def test_normal_case(self):
        ...
        self.assertAlmostEqual(result['correlation'], 0.78, places=2)
        self.assertAlmostEqual(result['score'], 26.67, places=2)
    ...
    def test_below_min_corr(self):
        ...
        self.assertLess(result['correlation'], 0.7)
